...
function QuickAds() {
    ...
    const uploadChange = (e) => {
        setForm({...form, upload_at: e.target.value})
    }
                ...
                <Card style={{ width: '100%', borderRadius: '1em' }}>
                    ...
                    <h3>Target Audience</h3>
                        <Form.Group className={'col-6 col-md-5 pt-4'}>
                            ...
                            <Form.Control as="select" defaultValue="others" onChange={(e) => setForm({...form, category:e.target.value})}>
                                <option>...</option>
                                {optionDataCategory()}
                        ...
                        <Form.Group className={'col-6 col-md-5 pt-4'}>
                            ...
                            <Form.Control type="text" value={form.interest} onChange={(e) => setForm({...form, interest: e.target.value})}/>
                        </Form.Group>
                ...
                <Card style={{ width: '100%', borderRadius: '1em' }}>
                    ...
                    <h3>Product Details</h3>
                        <Form.Group className={'col-6 pt-4'}>
                            ...
                            <Form.Control type="text" defaultValue={form.adsname} onChange={(e) => setForm({...form ,adsname:e.target.value}) }/>
                        </Form.Group>
                        <Form.Group className={'col-6 pt-4'}>
